...
/**
 * @brief The Class_ConformalDM class
 * Template for implementing a new model
 */
class Class_ConformalDM : public Class_Potential_Origin
{
public:
  Class_ConformalDM(const ISMConstants &smConstants);
  virtual ~Class_ConformalDM();
  ...
  double gDM, yDM, vev;
  double lambda; // Derived parameters

  double dms, dlambda, dT;
