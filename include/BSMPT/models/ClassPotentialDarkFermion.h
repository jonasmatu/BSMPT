...
/**
 * @brief The Class_DarkFermion class
 * Template for implementing a new model
 */
class Class_DarkFermion : public Class_Potential_Origin
{
public:
  Class_DarkFermion(const ISMConstants &smConstants);
  virtual ~Class_DarkFermion();
