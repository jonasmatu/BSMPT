...
/**
 * @brief The Class_DSParametrised class
 * DS for implementing a new model
 */
class Class_DSParametrised : public Class_Potential_Origin
{
public:
  Class_DSParametrised(const ISMConstants &smConstants);
  virtual ~Class_DSParametrised();
  ...
  double VTreeSimplified(const std::vector<double> &v, double T) const;
