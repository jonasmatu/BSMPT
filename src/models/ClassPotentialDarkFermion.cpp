 ...
 */
Class_DarkFermion::Class_DarkFermion(const ISMConstants &smConstants)
    : Class_Potential_Origin(smConstants)
{
  Model =
      ModelID::ModelIDs::DARKFERMION; // global int constant which will be used to
...
Class_DarkFermion::~Class_DarkFermion()
{
}
 ...
 */
std::vector<std::string> Class_DarkFermion::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_DarkFermion::addLegendTemp() const
{
  std::vector<std::string> labels;
 ...
 *
 */
std::vector<std::string> Class_DarkFermion::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_DarkFermion::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order";
  labels.push_back("omega");
 ...
 */
void Class_DarkFermion::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_DarkFermion::set_gen(const std::vector<double> &par)
{
  gDM    = par[0];
  yDM    = par[1];
  vev   = par[2];
 ...
 */
void Class_DarkFermion::set_CT_Pot_Par(const std::vector<double> &par)
{
 ...
 */
void Class_DarkFermion::write() const
{
 ...
 */
std::vector<double> Class_DarkFermion::calc_CT() const
{
...
void Class_DarkFermion::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_DarkFermion::SetCurvatureArrays()
{
  /*
...
bool Class_DarkFermion::CalculateDebyeSimplified()
{
...
bool Class_DarkFermion::CalculateDebyeGaugeSimplified()
{
  /*
...
double Class_DarkFermion::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_DarkFermion::VCounterSimplified(const std::vector<double> &v) const
{
...
void Class_DarkFermion::Debugging(const std::vector<double> &input,
